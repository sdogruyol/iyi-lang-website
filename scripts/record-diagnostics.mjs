...
// is not. Commits after the tag reach the site when they are released.
const release = releaseRef(repo);
requireReleaseTree(repo, release, "record:diagnostics");
const version = requireReleaseCompiler(iyi, release, "record:diagnostics");
