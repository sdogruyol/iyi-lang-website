/**
 * One hash, in one place, because two things compare digests and a second
 * implementation would let them disagree.
 *
 ...
 * built from. Both are SHA-256 over UTF-8 bytes, and both would be quietly
 * wrong in the same way if one of them padded, trimmed or hashed a view
 * instead of a copy.
 *
